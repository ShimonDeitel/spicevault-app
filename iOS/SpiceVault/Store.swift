...
final class Store: ObservableObject {
    ...
    private let fileName = "spicevault_entries.json"
    ...
    @discardableResult
    func add(_ entry: SpiceEntry, isPro: Bool) -> Bool {
    ...
    func load() {
        ...
        if let decoded = try? JSONDecoder().decode([SpiceEntry].self, from: data) {
            entries = decoded
        }
    }
