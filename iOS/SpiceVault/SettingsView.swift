...
struct SettingsView: View {
    ...
    @AppStorage("spicevault_showNotes") private var showNotes: Bool = true
    @AppStorage("spicevault_sortNewestFirst") private var sortNewestFirst: Bool = true
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/spicevault-app/privacy.html")!)
                        .accessibilityIdentifier("settingsPrivacyLink")
                    Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/spicevault-app/terms.html")!)
